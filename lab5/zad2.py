...
light_ambient2 = [0.5, 0.5, 0.0, 1.0]
light_diffuse2 = [0.9, 0.6, 0.0, 1.0]
light_specular2 = [1.0, 1.0, 1.0, 1.0]
light_position2 = [3.0, 2.0, 8.0, 1.0]
...
def increment(keyP):
    if (light_ambient2[keyP-1] < 1.0):
        light_ambient2[keyP-1] += 0.1

def decrement(keyP):
    if (light_ambient2[keyP-1] > 0.0):
        light_ambient2[keyP-1] -= 0.1
