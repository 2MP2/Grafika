...
# spacja sluzy do przelaczania miedzy trybem obracania kamery i poruszania kamery
def render(time):
    global theta
    global phi
    global scale
    ...
    if right_mouse_button_pressed:
        if change:
            scale += delta_y * 0.05 * pix2angle
        else: 
            R += delta_y * 0.05 * pix2angle
